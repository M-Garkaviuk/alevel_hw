...
class EmailAlreadyExistsException(ValueError):
    pass
...
class Developer(Employee):
    ...
    def __add__(self, other_developer):
        ...
        return Developer(tech_stack=new_tech_stack, full_name=new_name, daily_salary=new_salary, email=new_email)
...
john = Developer(['Python', 'JavaScript', 'React'], 'John Smith', 20.0, 'asdf@rinvs.dmvmds')
